...
#			ori $v0, $0, 30		# Retrieve system time
#			syscall
#			or $a1, $0, $a0		# Move the low order bytes to a1
#			ori $a0, $0, 1		# Set generator number
#			ori $v0, $0, 40		# Seed the generator with it
#			syscall
